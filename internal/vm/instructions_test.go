...
func TestEqual(t *testing.T) {
	tests := [...]struct {
		...
		{"true == []", Bool(true), Array{}, Bool(false)},
		...
		{"false == []", Bool(false), Array{}, Bool(true)},
...
func TestCompare(t *testing.T) {
	tests := []struct {
		...
		{"true <=> []", Bool(true), Array{}, -1},
		{"false <=> []", Bool(false), Array{}, -1},
