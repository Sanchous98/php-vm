...
func compare(ctx Context, x, y Value) Int {
	...
	case ObjectType:
		return hashCompare(ctx, x.AsObject(ctx).props, y.AsObject(ctx).props)
	}
...
func (i Int) AsObject(ctx Context) *Object {
	return &Object{ctx.ClassByName("stdClass"), NewHash(map[Value]Value{String("scalar"): i})}
}
func (i Int) AsCallable(Context) Callable { panic("not callable") }
...
func (f Float) AsObject(ctx Context) *Object {
	return &Object{ctx.ClassByName("stdClass"), NewHash(map[Value]Value{String("scalar"): f})}
}
func (f Float) AsCallable(Context) Callable { panic("not callable") }
...
func (b Bool) AsObject(ctx Context) *Object {
	return &Object{ctx.ClassByName("stdClass"), NewHash(map[Value]Value{String("scalar"): b})}
}
func (b Bool) AsCallable(Context) Callable { panic("not callable") }
...
func (s String) AsObject(ctx Context) *Object {
	return &Object{ctx.ClassByName("stdClass"), NewHash(map[Value]Value{String("scalar"): s})}
}
...
func (n Null) AsObject(ctx Context) *Object {
	return &Object{ctx.ClassByName("stdClass"), NewHash(nil)}
}
...
func (a *Array) AsObject(ctx Context) *Object {
	props := make(map[Value]Value, len(a.hash.values))

	for k, i := range a.hash.keys {
		props[k.AsString(ctx)] = a.hash.values[i]
	}

	return &Object{ctx.ClassByName("stdClass"), NewHash(props)}
}
func (a *Array) AsCallable(ctx Context) Callable {
	if len(a.hash.values) != 2 {
		panic("not callable")
	}

	var c Class
	switch x := a.hash.values[0].(type) {
	case *Object:
		c = x.impl
	case String:
		c = ctx.ClassByName(x)
	...
	// TODO: Closure with bound object
	//return c.GetMethod(ctx, a.hash.values[1].AsString(ctx))
	return nil
}
...
func (r Ref) AsObject(ctx Context) *Object    { return (*r.ref).AsObject(ctx) }
func (r Ref) AsCallable(ctx Context) Callable { return (*r.ref).AsCallable(ctx) }
...
func NewObject(class Class, init map[Value]Value) *Object {
	objCounter.Add(1)
	return &Object{impl: class, props: NewHash(init)}
}

func (o *Object) Name() String                { return o.impl.Name() }
...
func (o *Object) AsString(ctx Context) String { return o.impl.ToString(ctx, o) }
func (o *Object) AsNull(Context) Null         { return Null{} }
func (o *Object) Type() Type                  { return ObjectType }
func (o *Object) AsArray(Context) *Array      { return &Array{hash: o.props.clone()} }
func (o *Object) AsObject(Context) *Object    { return o }
func (o *Object) Invoke(ctx Context, scope Class, this *Object) {
	if c, ok := o.impl.(Callable); ok {
		c.Invoke(ctx, scope, this)
		return
	}

	panic("Object of type " + o.impl.Name() + " is not callable")
}
func (o *Object) AsCallable(Context) Callable {
	if c, ok := o.impl.(Callable); ok {
		return NewObject(&Closure{fn: c, this: o, scope: o.impl}, nil)
	}
	panic("Object of type " + o.impl.Name() + " is not callable")
}
func (o *Object) Identical(v Value) Bool       { return o == v }
func (o *Object) DebugInfo(ctx Context) String { return o.impl.DebugInfo(ctx) }
